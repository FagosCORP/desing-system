...
var require_uid = __commonJS({
  "../../node_modules/core-js/internals/uid.js"(exports, module) {
    ...
    var toString3 = uncurryThis2(1 .toString);
...
var require_classof_raw = __commonJS({
  "../../node_modules/core-js/internals/classof-raw.js"(exports, module) {
    var uncurryThis2 = require_function_uncurry_this();
    var toString3 = uncurryThis2({}.toString);
    var stringSlice = uncurryThis2("".slice);
    module.exports = function(it) {
...
var require_to_indexed_object = __commonJS({
  "../../node_modules/core-js/internals/to-indexed-object.js"(exports, module) {
    ...
    var requireObjectCoercible = require_require_object_coercible();
    module.exports = function(it) {
      return IndexedObject2(requireObjectCoercible(it));
    };
  }
});
...
var require_task = __commonJS({
  "../../node_modules/core-js/internals/task.js"(exports, module) {
    ...
    if (!set || !clear) {
      ...
      } else if (global3.addEventListener && isCallable(global3.postMessage) && !global3.importScripts && $location && $location.protocol !== "file:" && !fails2(globalPostMessageDefer)) {
...
var require_es_promise_constructor = __commonJS({
  "../../node_modules/core-js/modules/es.promise.constructor.js"() {
    ...
    $5({ global: true, constructor: true, wrap: true, forced: FORCED_PROMISE_CONSTRUCTOR }, {
...
var require_get_iterator_method = __commonJS({
  "../../node_modules/core-js/internals/get-iterator-method.js"(exports, module) {
    ...
    module.exports = function(it) {
      if (!isNullOrUndefined(it))
        return getMethod(it, ITERATOR2) || getMethod(it, "@@iterator") || Iterators[classof(it)];
    };
  }
});
...
var require_es_promise_catch = __commonJS({
  "../../node_modules/core-js/modules/es.promise.catch.js"() {
    ...
    var defineBuiltIn2 = require_define_built_in();
    var NativePromisePrototype = NativePromiseConstructor && NativePromiseConstructor.prototype;
    $5({ target: "Promise", proto: true, forced: FORCED_PROMISE_CONSTRUCTOR, real: true }, {
...
var require_es_promise_resolve = __commonJS({
  "../../node_modules/core-js/modules/es.promise.resolve.js"() {
    ...
    $5({ target: "Promise", stat: true, forced: IS_PURE || FORCED_PROMISE_CONSTRUCTOR }, {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                htmlElement = document2.querySelector(element);
                axe.reset();
                if (config) {
...
var $, from, checkCorrectnessOfIteration, INCORRECT_ITERATION;
    ...
    module.exports = function(Iterable, NAME, IteratorConstructor, next2, DEFAULT, IS_SET, FORCED3) {
      ...
      if (DEFAULT) {
        ...
        if (FORCED3)
          ...
          $5({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME }, methods);
      }
...
var global2, DOMIterables, DOMTokenListPrototype, ArrayIteratorMethods, createNonEnumerableProperty, wellKnownSymbol, ITERATOR, TO_STRING_TAG, ArrayValues, handlePrototype, COLLECTION_NAME;
...
var $2, uncurryThis, IndexedObject, toIndexedObject, arrayMethodIsStrict, nativeJoin, ES3_STRINGS, FORCED;
var init_es_array_join = __esm({
  "../../node_modules/core-js/modules/es.array.join.js"() {
    ...
    FORCED = ES3_STRINGS || !arrayMethodIsStrict("join", ",");
...
var $3, $map, arrayMethodHasSpeciesSupport, HAS_SPECIES_SUPPORT;
...
var $4, fails, isArray, isObject, toObject, lengthOfArrayLike, doesNotExceedSafeInteger, createProperty, arraySpeciesCreate, arrayMethodHasSpeciesSupport2, wellKnownSymbol2, V8_VERSION, IS_CONCAT_SPREADABLE, IS_CONCAT_SPREADABLE_SUPPORT, isConcatSpreadable, FORCED2;
var init_es_array_concat = __esm({
  "../../node_modules/core-js/modules/es.array.concat.js"() {
    ...
    FORCED2 = !IS_CONCAT_SPREADABLE_SUPPORT || !arrayMethodHasSpeciesSupport2("concat");
    $4({ target: "Array", proto: true, arity: 1, forced: FORCED2 }, {
