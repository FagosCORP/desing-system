...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-HR5XVH2P.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
} from "./chunk-NH37JLFD.js";
import {
  ActionBar
} from "./chunk-VPBGOADG.js";
import {
  ThemeProvider,
  convert,
  ...
  themes,
  useTheme
} from "./chunk-RMGGTFPB.js";
import {
  v
} from "./chunk-YHF4DAK7.js";
import {
  stringify
} from "./chunk-RUNKSPQ7.js";
import {
  esm_default
} from "./chunk-6JVAWBCK.js";
import {
  index_modern_default
} from "./chunk-3DQLK7ZQ.js";
import {
  require_memoizerific
} from "./chunk-OY2CXUDO.js";
import {
  curriedDarken$1,
  curriedLighten$1,
  curriedOpacify$1,
...
import {
  require_pickBy
} from "./chunk-FIMPSK56.js";
import {
  require_uniq
} from "./chunk-SCZZU5UZ.js";
import {
  require_mapValues
} from "./chunk-NEHIE5OX.js";
import {
  require_cloneDeep
} from "./chunk-KUC3OMSH.js";
import {
  renderElement,
  unmountElement
} from "./chunk-I476BYN3.js";
import {
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react4.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react4.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react4.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react4.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-FTHZIZZB.js");
...
var LazyColorControl = (0, import_react14.lazy)(() => import("./Color-3YIJY6X7-3JKNPZU5.js"));
...
var ArgTypes = (props) => {
  ...
  let resolved = useOf(of || "meta"), { argTypes, parameters } = getArgTypesFromResolved(resolved, props), argTypesParameters = ((_a = parameters.docs) == null ? void 0 : _a.argTypes) || {}, include = props.include ?? argTypesParameters.include, exclude = props.exclude ?? argTypesParameters.exclude, sort = props.sort ?? argTypesParameters.sort, filteredArgTypes = (0, import_preview_api.filterArgTypes)(argTypes, include, exclude);
...
var StoryTable = (props) => {
  ...
  try {
    ...
    let argTypes = (0, import_preview_api2.filterArgTypes)(story.argTypes, include, exclude), mainLabel = getComponentName(component) || "Story", tabs = { [mainLabel]: { rows: argTypes, args, globals, updateArgs, resetArgs } }, storyHasArgsWithControls = argTypes && Object.values(argTypes).find((v2) => !!(v2 == null ? void 0 : v2.control));
...
var ExternalDocsContext = class extends import_preview_api6.DocsContext {
...
var ExternalPreview = class extends import_preview_api5.Preview {
  constructor(projectAnnotations) {
    ...
    this.initialize({ getStoryIndex: () => this.storyIndex, importFn: (path) => Promise.resolve(this.moduleExportsByImportPath[path]), getProjectAnnotations: () => (0, import_preview_api5.composeConfigs)([{ parameters: { docs: { story: { inline: true } } } }, this.projectAnnotations]) });
  }
};
...
var ExternalDocs = ({ projectAnnotationsList, children }) => {
  var _a;
  let projectAnnotations = (0, import_preview_api4.composeConfigs)(projectAnnotationsList), preview2 = usePreview(projectAnnotations), docsParameter = { ...(_a = projectAnnotations.parameters) == null ? void 0 : _a.docs, page: () => children };
...
var ErrorBoundary = class extends import_react65.Component {
  constructor() {
    super(...arguments);
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./@mdx-js_react.js").then(({ MDXProvider }) => renderElement(import_react65.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react65.default.createElement(MDXProvider, { components }, import_react65.default.createElement(Docs, { context, docsParameter }))), element)).then(resolve);
      });
...
//# sourceMappingURL=chunk-FQJGCVRF.js.map
